  ...
  return (
    <div className="mb-8 p-6 text-center">
      ...
      <button
        onClick={handleLogin}
        disabled={isLoading}
        className="inline-flex items-center px-4 py-2 text-white text-sm font-medium rounded-lg hover:bg-gray-800/20 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
