    ...
    <nav className="text-white border-b border-white/10 px-3 sm:px-6 py-4 relative">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center space-x-4 lg:space-x-6">
          <a href="https://brunobianchi.dev/#sobre" className="text-xs sm:text-sm hover:underline whitespace-nowrap">
            Sobre
          </a>
          <a href="https://brunobianchi.dev/#experiencias" className="text-xs sm:text-sm hover:underline whitespace-nowrap">
            Experiências
          </a>
