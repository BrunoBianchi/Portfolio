...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-white font-sans">
      <section
        className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12 lg:py-16 flex items-center justify-center"
        ...
        <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-center">
          <header className="text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg text-gray-400 max-w-lg mx-auto lg:mx-0 mb-4 sm:mb-6 leading-relaxed font-light">
              Desenvolvedor{" "}
              <span className="text-gray-300 font-normal">FullStack</span>{" "}
              focado em criar soluções digitais eficientes e escaláveis.
            </p>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <h2
            id="about-heading"
            className="text-lg sm:text-xl lg:text-2xl font-semibold mb-4 sm:mb-6 text-center text-gray-200"
          >
            Sobre Mim
          </h2>
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8 items-center">
            <div className="space-y-4">
              <p className="text-gray-400 leading-relaxed">
                ...
                experiência sólida em desenvolvimento fullstack e engenharia de
                dados. Atualmente trabalho em projetos de P&D na área de machine
                learning e otimização de redes móveis.
              </p>
              <p className="text-gray-400 leading-relaxed">
                Tenho experiência em liderar equipes e projetos, sempre buscando
                soluções eficientes e escaláveis. Gosto de enfrentar desafios
                complexos e transformar ideias em produtos digitais de
                qualidade.
              </p>
            </div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2
            ...
            className="text-lg sm:text-xl lg:text-2xl font-semibold mb-4 sm:mb-6 text-center lg:text-left text-gray-200"
          >
          ...
          <div className="space-y-5 sm:space-y-6 relative">
            ...
            <div
              className="absolute left-6 top-8 bottom-0 w-0.5 bg-gradient-to-b from-primary via-primary/60 to-transparent hidden md:block animate-timeline-draw"
              aria-hidden="true"
            ></div>

            {/* Animated Background Glow with Pulsing Effect */}
            <div
              className="absolute left-5 top-6 w-2 h-full bg-gradient-to-b from-primary/20 via-primary/10 to-transparent blur-sm rounded-full hidden md:block animate-pulse"
              aria-hidden="true"
            ></div>

            {/* Additional Glow Layer */}
            <div
              className="absolute left-5.5 top-6 w-1 h-full bg-gradient-to-b from-primary/30 to-transparent blur-xs rounded-full hidden md:block"
              aria-hidden="true"
            ></div>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div
                  className={`absolute left-4 top-4 w-4 h-4 rounded-full border-4 border-background shadow-lg hidden md:block experience-dot ${
                    index === 0
                      ? "bg-gradient-to-r from-primary to-amber-400 animate-glow-pulse"
                      : "bg-gray-600"
                  }`}
                  aria-hidden="true"
                >
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6">
            <h2
              id="contact-heading"
              className="text-lg sm:text-xl lg:text-2xl font-semibold mb-3 text-gray-200"
            >
              Vamos Conversar?
            </h2>
            <p className="text-gray-400 text-sm leading-relaxed max-w-2xl mx-auto">
              Interessado em colaborar ou tem alguma pergunta? Estou sempre
              aberto a novas oportunidades e conversas interessantes.
            </p>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      linkedin.com/in/bruno-bianchi-65a442268
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6">
                ...
                <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                  Seja para um projeto freelance, oportunidade de trabalho ou
                  apenas uma conversa sobre tecnologia, ficarei feliz em
                  conversar com você.
                </p>
